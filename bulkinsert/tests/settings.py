...
# python manage.py test --settings=django-bulkinsert.tests.settings django-bulkinsert
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'django-bulkinsert-test.db',
...
INSTALLED_APPS = (
    # Add bulkinsert app itself and the tests models
    'django.contrib.auth',
...
ROOT_URLCONF = 'bulkinsert.tests.urls'

# Make this unique, and don't share it with anybody.
SECRET_KEY = 't_8)4w_bulkinsert_not_secret_test_key_7^b*s%w$zrud'
