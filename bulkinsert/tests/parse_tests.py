...
from bulkinsert.management.commands.bulkinsert import Command
from bulkinsert.tests.models import Country, UnitOfMeasure, Item, Organisation
...
class CommandParseTest(TestCase):
    ...
    def command(self, filename, defaults='country=KE(Country|code)',
                expected_errs=[]):
        """ Run core bulkinsert command to parse file """
        cmd = Command()
